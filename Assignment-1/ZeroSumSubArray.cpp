...
int main()
{
  ...
  std::cout << "Testing an array with repeating numbers [4,5,2,-1,-3,-3,4,6,-7]:  " << ZeroSumSubArray(test1) << std::endl;
  std::cout << "Testing an array with no repeating numbers [1,8,73,11,9]:  " << ZeroSumSubArray(test2) << std::endl;
  std::cout << "Testing an array that contains 0 [8,-5,0,-2,3,-4]:  " << ZeroSumSubArray(test3) << std::endl;
  std::cout << "Testing an array that alternates two numbers [1,-1,1,-1,1,-1]:  " << ZeroSumSubArray(test4) << std::endl;
}
