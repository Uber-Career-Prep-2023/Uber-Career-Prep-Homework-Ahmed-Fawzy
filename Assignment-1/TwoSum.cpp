...
for(int i=0;i<arr.size();i++)
    {   
        if(k-arr[i]==arr[i] && m[arr[i]]>0) ans=ans+m[arr[i]];  
        m[arr[i]]++;      
    }
...
std::cout<<"Input Array 1: [1, 10, 8, 3, 2, 5, 7, 2, -2, -1]\n"<<"Input k: "<<k1<<"\n"<<"Output: "<<TwoSum(test1,k1)<<"\n\n";
std::cout<<"Input Array 2: [1, 10, 8, 3, 2, 5, 7, 2, -2, -1]\n"<<"Input k: "<<k2<<"\n"<<"Output: "<<TwoSum(test1,k2)<<"\n\n";
std::cout<<"Input Array 3: [4, 3, 3, 5, 7, 0, 2, 3, 8, 6]\n"<<"Input k: "<<k3<<"\n"<<"Output: "<<TwoSum(test2,k3)<<"\n\n";
std::cout<<"Input Array 4: [4, 3, 3, 5, 7, 0, 2, 3, 8, 6]\n"<<"Input k: "<<k4<<"\n"<<"Output: "<<TwoSum(test2,k4)<<"\n\n";
