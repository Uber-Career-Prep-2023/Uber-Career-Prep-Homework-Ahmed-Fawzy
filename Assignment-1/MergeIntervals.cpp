...
int main()
{
    ...
    std::cout << "Input intervals with some overlaps: [(2, 3), (4, 8), (1, 2), (5, 7), (9, 12)]" << std::endl
              << "Output 1: ";
    print(MergeIntervals(test1));

    std::cout << "Input intervals with all overlaps: [(5, 8), (6, 10), (2, 4), (3, 6)]" << std::endl
              << "Output 2: ";
    print(MergeIntervals(test2));

    std::cout << "Input intervals with no overlaps: [(10, 12), (5, 6), (7, 9), (1, 3)]" << std::endl
              << "Output 3: ";
