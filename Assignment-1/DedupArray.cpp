...
std::cout<<"Input 1: [1, 2, 2, 3, 3, 3, 4, 4, 4, 4]"<<std::endl<<"Modified Array: ";
print(DedupArray(test1));

std::cout<<"Input 1: [0, 0, 1, 4, 5, 5, 5, 8, 9, 9, 10, 11, 15, 15]"<<std::endl<<"Modified Array: ";
print(DedupArray(test2));

std::cout<<"Input 1: [1, 3, 4, 8, 10, 12]"<<std::endl<<"Modified Array: ";
